...
request_total = Counter(
    "generated_request_total", "Generated placeholder requests", ["method", "path"]
)
...
def get_invoice(
    invoice_id: str = Path(..., title="ID of the invoice to retrieve")
) -> dict[str, object]:
    return {
        "change_id": CHANGE_ID,
        "service": SERVICE,
...
def approve_invoice(
    invoice_id: str = Path(..., title="ID of the invoice to approve"),
